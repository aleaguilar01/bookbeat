...
import { getMusicHome, loginWithSpotify, handleSpotifyCallback, handleSpotifyPlaylists, handleSpotifyRefreshToken } from '../controllers/musicController';  // Import the controller
